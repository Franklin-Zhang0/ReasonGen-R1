...
for name in "${model_name_list[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=4 python $HOME_PATH/project/T2I-CompBench/UniDet_eval/2D_spatial_eval.py --outpath="$HOME_PATH/project/T2I-CompBench/examples/outputs/${name}/spatial_val" & 
    CUDA_VISIBLE_DEVICES=5 python $HOME_PATH/project/T2I-CompBench/UniDet_eval/numeracy_eval.py --outpath="$HOME_PATH/project/T2I-CompBench/examples/outputs/${name}/numeracy_val" & 
    CUDA_VISIBLE_DEVICES=6 python $HOME_PATH/project/T2I-CompBench/UniDet_eval/2D_spatial_eval.py --outpath="$HOME_PATH/project/T2I-CompBench/examples/outputs/${name}/complex_val" --complex True &
    ...
    CUDA_VISIBLE_DEVICES=7 python $HOME_PATH/project/T2I-CompBench/3_in_1_eval/3_in_1.py --outpath="$HOME_PATH/project/T2I-CompBench/examples/outputs/${name}/complex_val" --data_path=${data_path} &
    wait
done
